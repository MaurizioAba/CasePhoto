...
import { COLORS, FINISHES, MATERIALS, MODELS } from "@/src/validators/option-validator"
      ...
      async function saveConfiguration() {
        try {
          ...
          toast({
            title: 'Qualcosa è andato storto',
            description:
              'Si è verificato un problema durante il salvataggio della configurazione. Riprova.',
            variant: 'destructive',
          })
        }
      }
    ...
    <div className = "relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
        ...
        <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
            <ScrollArea className='relative flex-1 overflow-auto'>
                <div aria-hidden="true" className="absolute z-10 inset-x-0 bottom-0 h-12 bg-bg-gradient-to-t from-white pointer-events-none" />

                <div className="px-8 pb-12 pt-8">
                    <h2 className="tracking-tight font-bold text-3xl">
                      Customizza il tuo case
                    </h2>
                        ...
                        <RadioGroup
                          ...
                          <div className='mt-3 flex items-center space-x-3'>
                                    ...
                                    <DropdownMenuContent>
                                        {MODELS.options.map((model) => (
                                            ...
                                            onClick={() => {
                                                ...
                                                <Check className={cn("mr-2 h-4 w-4", model.label === options.model.label 
                                                    ? "opacity-100" 
                                                    :  "opacity-0"
                                                )}/>
                                                {model.label}
                            ...
                            {[MATERIALS, FINISHES].map(
                                ({name, options: selectableOptinals}) =>(
